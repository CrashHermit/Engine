...
- [ ] **Overindulgence & trauma specifics** — overindulgence complication (likely reuse the
      consequence machinery / narrated complication); the **"character lost" endgame flow**
      (new character in same world? game-over? campaign continuity — touches world/character
      services + TUI).
