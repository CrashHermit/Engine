...
class PartRepository:
    ...
    def add_part(
        ...
        self._base.create_edge(
            type_name=EdgeType.HAS_PART, source=character, target=part
        )
        return part

    def attach(self, source: Vertex, target: Vertex) -> None:
        self._base.create_edge(
            type_name=EdgeType.ATTACHED_TO, source=source, target=target
        )
    ...
    def add_manipulator(self, part: Vertex) -> Vertex:
        ...
        self._base.create_edge(
            type_name=EdgeType.IS_MANIPULATOR, source=part, target=manipulator
        )
        return manipulator
    ...
    def add_controllable(self, part: Vertex) -> Vertex:
        ...
        self._base.create_edge(
            type_name=EdgeType.IS_CONTROLLABLE, source=part, target=controllable
        )
        return controllable
    ...
    def add_opening(self, part: Vertex) -> Vertex:
        ...
        self._base.create_edge(
            type_name=EdgeType.IS_OPENING, source=part, target=opening
        )
        return opening
    ...
    def add_channel(self, part: Vertex) -> Vertex:
        ...
        self._base.create_edge(
            type_name=EdgeType.IS_CHANNEL, source=part, target=channel
        )
        return channel
    ...
    def add_storage(self, part: Vertex) -> Vertex:
        ...
        self._base.create_edge(
            type_name=EdgeType.IS_STORAGE, source=part, target=storage
        )
        return storage
    ...
    def add_movement(self, part: Vertex) -> Vertex:
        ...
        self._base.create_edge(
            type_name=EdgeType.IS_MOVEMENT, source=part, target=movement
        )
        return movement
