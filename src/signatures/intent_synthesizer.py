...
class IntentSynthesizerSignature(Signature):
    ...
    intent_alignment_history: str = InputField(description="The clarification Q&A that resolved the player's intent")

    synthesized_message: str = OutputField(description="A single clear statement of the player's full intent")
