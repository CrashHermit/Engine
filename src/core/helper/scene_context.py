...
class SceneContextHelper:
    ...
    def generate_temperature_scene_context(self, location_data: LocationData) -> str:
        ...
        frigid_descriptions = ["The air is freezing.", "The air is cold.", "The air is cool."]
        freezing_descriptions = ["The air is freezing.", "The air is cold.", "The air is cool."]
        ...
        warm_descriptions = ["The air is warm.", "The air is hot.", "The air is scorching."]
        hot_descriptions = ["The air is hot.", "The air is scorching.", "The air is scorching."]
        scorching_descriptions = ["The air is scorching.", "The air is scorching.", "The air is scorching."]
    ...
    def generate_precipitation_scene_context(self, location_data: LocationData) -> str:
        ...
        none_descriptions = ["There is no precipitation.", "The sky is clear.", "Nothing is falling from the sky."]
        drizzle_descriptions = ["There is a light drizzle.", "There is a light drizzle.", "There is a light drizzle."]
        light_descriptions = ["There is a light rain.", "There is a light rain.", "There is a light rain."]
        steady_descriptions = ["There is a steady rain.", "There is a steady rain.", "There is a steady rain."]
        heavy_descriptions = ["There is a heavy rain.", "There is a heavy rain.", "There is a heavy rain."]
        torrential_descriptions = ["There is a torrential rain.", "There is a torrential rain.", "There is a torrential rain."]
        cloudburst_descriptions = ["There is a cloudburst.", "There is a cloudburst.", "There is a cloudburst."]
    ...
    def generate_wind_direction_scene_context(self, location_data: LocationData) -> str:
        ...
        calm_descriptions = ["The air is still.", "A gentle wind stirs the air.", "A steady breeze tugs at clothes and loose leaves."]
        gentle_descriptions = ["A gentle wind stirs the air.", "A steady breeze tugs at clothes and loose leaves.", "Gusts come and go, whipping dust and branches."]
        breezy_descriptions = ["A steady breeze tugs at clothes and loose leaves.", "Gusts come and go, whipping dust and branches.", "Strong winds howl; keeping your footing takes effort."]
        blustery_descriptions = ["Gusts come and go, whipping dust and branches.", "Strong winds howl; keeping your footing takes effort", "The wind screams in violent gusts"]
        gale_descriptions = ["Strong winds howl; keeping your footing takes effort.", "The wind screams in violent gusts.", "The wind is devastating; nothing exposed stands easy."]
        storm_descriptions = ["The wind screams in violent gusts.", "The wind is devastating; nothing exposed stands easy.", "The wind is devastating; nothing exposed stands easy."]
        hurricane_descriptions = ["The wind is devastating; nothing exposed stands easy.", "The wind is devastating; nothing exposed stands easy.", "The wind is devastating; nothing exposed stands easy."]
        ...
        wind_intensity_description: list[str] = wind_intensity_descriptions[wind_intensity]
