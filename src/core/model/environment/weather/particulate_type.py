...
PARTICULATE_TYPE_GRID: dict[
    ...
    (BiomeEnum.GLACIAL_MARGIN, WindIntensityBand.BLUSTERY): ParticulateTypeEnum.NONE,
    ...
    (BiomeEnum.GLACIAL_MARGIN, WindIntensityBand.HURRICANE): ParticulateTypeEnum.NONE,
    # -- MELTING_PACK --
    ...
    (BiomeEnum.LICHEN_WOODLAND, WindIntensityBand.BLUSTERY): ParticulateTypeEnum.NONE,
    ...
    (BiomeEnum.LICHEN_WOODLAND, WindIntensityBand.HURRICANE): ParticulateTypeEnum.NONE,
    # -- OPEN_BOREAL --
    ...
    (BiomeEnum.OPEN_BOREAL, WindIntensityBand.HURRICANE): ParticulateTypeEnum.POLLEN,
    # -- DENSE_TAIGA --
    ...
    (BiomeEnum.SAGEBRUSH_STEPPE, WindIntensityBand.GENTLE): ParticulateTypeEnum.NONE,
    (BiomeEnum.SAGEBRUSH_STEPPE, WindIntensityBand.BREEZY): ParticulateTypeEnum.DUST,
    (BiomeEnum.SAGEBRUSH_STEPPE, WindIntensityBand.BLUSTERY): ParticulateTypeEnum.DUST,
    ...
    (BiomeEnum.SAGEBRUSH_STEPPE, WindIntensityBand.HURRICANE): ParticulateTypeEnum.DUST,
    # -- SHORTGRASS_PRAIRIE --
    ...
    (BiomeEnum.MIXED_PRAIRIE, WindIntensityBand.BLUSTERY): ParticulateTypeEnum.POLLEN,
    ...
    (BiomeEnum.MIXED_PRAIRIE, WindIntensityBand.HURRICANE): ParticulateTypeEnum.POLLEN,
    # -- DECIDUOUS_FOREST --
    ...
    (BiomeEnum.COOL_RAINFOREST, WindIntensityBand.BREEZY): ParticulateTypeEnum.SPORES,
    ...
    (BiomeEnum.FEN_WETLAND, WindIntensityBand.HURRICANE): ParticulateTypeEnum.SPORES,
    # -- BADLANDS --
    ...
    (BiomeEnum.LAUREL_FOREST, WindIntensityBand.BLUSTERY): ParticulateTypeEnum.SPORES,
    ...
    (BiomeEnum.WARM_RAINFOREST, WindIntensityBand.BREEZY): ParticulateTypeEnum.SPORES,
    ...
    (BiomeEnum.SWAMP_FOREST, WindIntensityBand.BLUSTERY): ParticulateTypeEnum.SPORES,
    ...
    (BiomeEnum.SWAMP_FOREST, WindIntensityBand.HURRICANE): ParticulateTypeEnum.SPORES,
    # -- SAND_DESERT --
    ...
    (BiomeEnum.SAVANNA_SCRUB, WindIntensityBand.BLUSTERY): ParticulateTypeEnum.SMOKE,
    ...
    (BiomeEnum.SAVANNA_SCRUB, WindIntensityBand.HURRICANE): ParticulateTypeEnum.SMOKE,
    # -- SEASONAL_FOREST --
    ...
    (BiomeEnum.SEASONAL_FOREST, WindIntensityBand.BREEZY): ParticulateTypeEnum.SPORES,
    ...
    (BiomeEnum.WET_RAINFOREST, WindIntensityBand.BREEZY): ParticulateTypeEnum.SPORES,
    (BiomeEnum.WET_RAINFOREST, WindIntensityBand.BLUSTERY): ParticulateTypeEnum.SPORES,
    ...
    (BiomeEnum.WET_RAINFOREST, WindIntensityBand.HURRICANE): ParticulateTypeEnum.SPORES,
    # -- MANGROVE_SWAMP --
    ...
    (BiomeEnum.MANGROVE_SWAMP, WindIntensityBand.BREEZY): ParticulateTypeEnum.SPORES,
    (BiomeEnum.MANGROVE_SWAMP, WindIntensityBand.BLUSTERY): ParticulateTypeEnum.SPORES,
    ...
    (BiomeEnum.MANGROVE_SWAMP, WindIntensityBand.HURRICANE): ParticulateTypeEnum.SPORES,
    # -- SCORCHING_WASTELAND --
    ...
    (BiomeEnum.MONSOON_FOREST, WindIntensityBand.BREEZY): ParticulateTypeEnum.SPORES,
    (BiomeEnum.MONSOON_FOREST, WindIntensityBand.BLUSTERY): ParticulateTypeEnum.SPORES,
    ...
    (BiomeEnum.MONSOON_FOREST, WindIntensityBand.HURRICANE): ParticulateTypeEnum.SPORES,
    # -- MOIST_FOREST --
    ...
    (BiomeEnum.MOIST_FOREST, WindIntensityBand.BLUSTERY): ParticulateTypeEnum.POLLEN,
    ...
    (BiomeEnum.MOIST_FOREST, WindIntensityBand.HURRICANE): ParticulateTypeEnum.POLLEN,
    # -- LOWLAND_RAINFOREST --
    ...
    (BiomeEnum.FLOODED_JUNGLE, WindIntensityBand.BREEZY): ParticulateTypeEnum.SPORES,
    (BiomeEnum.FLOODED_JUNGLE, WindIntensityBand.BLUSTERY): ParticulateTypeEnum.SPORES,
    ...
    (BiomeEnum.FLOODED_JUNGLE, WindIntensityBand.HURRICANE): ParticulateTypeEnum.SPORES,
}
