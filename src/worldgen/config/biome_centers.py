...
BIOME_CENTERS: list[BiomeCenter] = [
    ...
    BiomeCenter(biome=BiomeEnum.MOIST_TEMPERATE_FOREST, ideal_temp=0.38, ideal_precip=0.75),
    ...
    BiomeCenter(biome=BiomeEnum.EVERGREEN_OAK_FOREST, ideal_temp=0.52, ideal_precip=0.55),
    BiomeCenter(biome=BiomeEnum.LAUREL_FOREST, ideal_temp=0.58, ideal_precip=0.75),
    BiomeCenter(biome=BiomeEnum.TEMPERATE_RAINFOREST, ideal_temp=0.52, ideal_precip=0.92),
    BiomeCenter(biome=BiomeEnum.PEAT_MARSH, ideal_temp=0.55, ideal_precip=1.00),
    # ── WARM (0.6 to 0.75) ────────────────────────────────────────────────
    BiomeCenter(biome=BiomeEnum.SEMI_ARID_SHRUBLAND, ideal_temp=0.70, ideal_precip=0.06),
    ...
    BiomeCenter(biome=BiomeEnum.SUBTROPICAL_RAINFOREST, ideal_temp=0.72, ideal_precip=0.82),
    ...
    BiomeCenter(biome=BiomeEnum.TROPICAL_RAINFOREST, ideal_temp=0.88, ideal_precip=0.88),
    ...
    BiomeCenter(biome=BiomeEnum.SCORCHING_WASTELAND, ideal_temp=0.98, ideal_precip=0.00),
    ...
    BiomeCenter(biome=BiomeEnum.EQUATORIAL_RAINFOREST, ideal_temp=0.95, ideal_precip=0.95),
