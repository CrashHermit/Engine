...
| 5 | `VulcanismStage` | Subduction arcs, hotspot island chains, and mid-ocean ridges into `uplift`; `volcanism` field. Stashes volcano *candidates* for materialization once the terrain is final. |
